...
func (this *KucoinCore) FetchMarkets(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(uta) {
			...
			retRes156219 := (<-this.FetchUTAMarkets(params))
			PanicOnError(retRes156219)
			ch <- retRes156219
			return nil
		}
...
func (this *KucoinCore) FetchUTAMarkets(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
			...
			retRes212112 := (<-this.LoadTimeDifference())
...
func (this *KucoinCore) FetchTickers(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsTrue((!IsEqual(tradeType, nil))) || IsTrue(uta)) {
			...
			retRes283019 := (<-this.FetchContractTickers(symbols, params))
...
func (this *KucoinCore) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(uta) {
			...
			retRes316419 := (<-this.FetchUTAOHLCV(symbol, timeframe, since, limit, params))
			PanicOnError(retRes316419)
			ch <- retRes316419
			return nil
		} else if IsTrue(GetValue(market, "contract")) {

			retRes316619 := (<-this.FetchContractOHLCV(symbol, timeframe, since, limit, params))
			PanicOnError(retRes316619)
			ch <- retRes316619
			return nil
		} else {

			retRes316819 := (<-this.FetchSpotOHLCV(symbol, timeframe, since, limit, params))
...
func (this *KucoinCore) FetchUTAOHLCV(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes319119 := (<-this.FetchPaginatedCallDeterministic("fetchUTAOHLCV", symbol, since, limit, timeframe, params, maxLimit))
...
func (this *KucoinCore) FetchSpotOHLCV(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes326019 := (<-this.FetchPaginatedCallDeterministic("fetchSpotOHLCV", symbol, since, limit, timeframe, params, maxLimit))
...
func (this *KucoinCore) FetchContractOHLCV(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes331719 := (<-this.FetchPaginatedCallDeterministic("fetchContractOHLCV", symbol, since, limit, timeframe, params, maxLimit))
			PanicOnError(retRes331719)
			ch <- retRes331719
			return nil
		}
		var market interface{} = this.Market(symbol)
...
func (this *KucoinCore) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsEqual(accountType, "contract")) {
			...
			retRes342019 := (<-this.FetchContractDepositAddress(code, params))
...
func (this *KucoinCore) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(market, "spot")) {
			...
			retRes373519 := (<-this.CreateSpotOrder(symbol, typeVar, side, amount, price, params))
			PanicOnError(retRes373519)
			ch <- retRes373519
			return nil
		} else if IsTrue(GetValue(market, "contract")) {

			retRes373719 := (<-this.CreateContractOrder(symbol, typeVar, side, amount, price, params))
			PanicOnError(retRes373719)
			ch <- retRes373719
			return nil
		} else {
...
func (this *KucoinCore) CreateMarketOrderWithCost(symbol interface{}, side interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes41208 := (<-this.LoadMarkets())
		PanicOnError(retRes41208)
		var req interface{} = map[string]interface{}{
			"cost": cost,
		}

		retRes412415 := (<-this.CreateOrder(symbol, "market", side, cost, nil, this.Extend(req, params)))
		PanicOnError(retRes412415)
		ch <- retRes412415
		return nil
...
func (this *KucoinCore) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes414015 := (<-this.CreateMarketOrderWithCost(symbol, "buy", cost, params))
...
func (this *KucoinCore) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes415615 := (<-this.CreateMarketOrderWithCost(symbol, "sell", cost, params))
...
func (this *KucoinCore) CreateOrders(orders interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsTrue(isSpot) && IsTrue(isContract)) {
			...
			retRes418719 := (<-this.CreateSpotOrders(orders, params))
			PanicOnError(retRes418719)
			ch <- retRes418719
			return nil
		} else if IsTrue(isContract) {

			retRes418919 := (<-this.CreateContractOrders(orders, params))
			PanicOnError(retRes418919)
			ch <- retRes418919
			return nil
		} else {
...
func (this *KucoinCore) CancelOrder(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsTrue((IsEqual(marketType, "spot"))) || IsTrue((IsEqual(marketType, "margin")))) {
			...
			retRes441419 := (<-this.CancelSpotOrder(id, symbol, params))
			PanicOnError(retRes441419)
			ch <- retRes441419
			return nil
		} else {

			retRes441619 := (<-this.CancelContractOrder(id, symbol, params))
			PanicOnError(retRes441619)
			ch <- retRes441619
			return nil
		}
...
func (this *KucoinCore) CancelAllOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsTrue((IsEqual(marketType, "spot"))) || IsTrue((IsEqual(marketType, "margin")))) {
			...
			retRes463919 := (<-this.CancelAllSpotOrders(symbol, params))
			PanicOnError(retRes463919)
			ch <- retRes463919
			return nil
		} else {

			retRes464119 := (<-this.CancelAllContractOrders(symbol, params))
			PanicOnError(retRes464119)
			ch <- retRes464119
			return nil
		}
	...
	go func() interface{} {
		...
		if IsTrue(IsEqual(symbol, nil)) {
			...
			if IsTrue(IsTrue(IsTrue(IsTrue(IsTrue(IsEqual(typeVar, "spot")) || IsTrue(IsEqual(typeVar, "margin"))) || IsTrue(IsEqual(typeVar, "swap"))) || IsTrue(IsEqual(typeVar, "future"))) || IsTrue(IsEqual(typeVar, "contract"))) {
				...
				marketTypeparamsVariable := this.HandleMarketTypeAndParams("fetchOrdersByStatus", nil, map[string]interface{}{})
				marketType = GetValue(marketTypeparamsVariable, 0)
				params = GetValue(marketTypeparamsVariable, 1)
			}
		} else {
		...
		if IsTrue(IsTrue((IsEqual(marketType, "spot"))) || IsTrue((IsEqual(marketType, "margin")))) {
			...
			retRes477919 := (<-this.FetchSpotOrdersByStatus(status, symbol, since, limit, params))
			PanicOnError(retRes477919)
			ch <- retRes477919
			return nil
		} else {

			retRes478119 := (<-this.FetchContractOrdersByStatus(status, symbol, since, limit, params))
			PanicOnError(retRes478119)
			ch <- retRes478119
			return nil
		}
...
func (this *KucoinCore) FetchContractOrdersByStatus(status interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes494619 := (<-this.FetchPaginatedCallDynamic("fetchOrdersByStatus", symbol, since, limit, params))
			PanicOnError(retRes494619)
			ch <- retRes494619
			return nil
		}
...
func (this *KucoinCore) FetchClosedOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes506319 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
			PanicOnError(retRes506319)
			ch <- retRes506319
			return nil
		}

		retRes506515 := (<-this.FetchOrdersByStatus("done", symbol, since, limit, params))
...
func (this *KucoinCore) FetchOpenOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes509919 := (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
			PanicOnError(retRes509919)
			ch <- retRes509919
			return nil
		}

		retRes510115 := (<-this.FetchOrdersByStatus("active", symbol, since, limit, params))
...
func (this *KucoinCore) FetchOrder(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsTrue((IsEqual(marketType, "spot"))) || IsTrue((IsEqual(marketType, "margin")))) {
			...
			retRes513519 := (<-this.FetchSpotOrder(id, symbol, params))
			PanicOnError(retRes513519)
			ch <- retRes513519
			return nil
		} else {

			retRes513719 := (<-this.FetchContractOrder(id, symbol, params))
			PanicOnError(retRes513719)
			ch <- retRes513719
			return nil
		}
...
func (this *KucoinCore) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes565115 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func (this *KucoinCore) FetchMyTrades(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsTrue((IsEqual(marketType, "spot"))) || IsTrue((IsEqual(marketType, "margin")))) {
			...
			retRes567819 := (<-this.FetchMySpotTrades(symbol, since, limit, params))
			PanicOnError(retRes567819)
			ch <- retRes567819
			return nil
		} else {

			retRes568019 := (<-this.FetchMyContractTrades(symbol, since, limit, params))
...
func (this *KucoinCore) FetchMySpotTrades(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes57018 := (<-this.LoadMarkets())
		PanicOnError(retRes57018)
		var paginate interface{} = false
		...
		if IsTrue(paginate) {
			...
			retRes570519 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func (this *KucoinCore) FetchMyContractTrades(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes58238 := (<-this.LoadMarkets())
		PanicOnError(retRes58238)
		var paginate interface{} = false
		paginateparamsVariable := this.HandleOptionAndParams(params, "fetchMyTrades", "paginate")
		paginate = GetValue(paginateparamsVariable, 0)
		params = GetValue(paginateparamsVariable, 1)
		if IsTrue(paginate) {
			...
			retRes582719 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func (this *KucoinCore) FetchDeposits(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsEqual(accountType, "contract")) {
			...
			retRes653819 := (<-this.FetchContractDeposits(code, since, limit, params))
		...
		if IsTrue(paginate) {
			...
			retRes654319 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func (this *KucoinCore) FetchWithdrawals(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsEqual(accountType, "contract")) {
			...
			retRes668819 := (<-this.FetchContractWithdrawals(code, since, limit, params))
		...
		if IsTrue(paginate) {
			...
			retRes669319 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params, 500))
			PanicOnError(retRes669319)
			ch <- retRes669319
			return nil
		}
		var request interface{} = map[string]interface{}{}
...
func (this *KucoinCore) FetchContractWithdrawals(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes67718 := (<-this.LoadMarkets())
		PanicOnError(retRes67718)
		var request interface{} = map[string]interface{}{}
		var currency interface{} = nil
		if IsTrue(!IsEqual(code, nil)) {
			currency = this.Currency(code)
...
func (this *KucoinCore) FetchBalance(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsEqual(typeVar, "contract")) {
			...
			retRes685419 := (<-this.FetchContractBalance(params))
...
func (this *KucoinCore) FetchLedger(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes744919 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
			PanicOnError(retRes744919)
			ch <- retRes744919
			return nil
		}
		var request interface{} = map[string]interface{}{}
		...
		params = GetValue(typeVarparamsVariable, 1)
		var accountsByType interface{} = this.SafeDict(this.Options, "accountsByType")
		typeVar = this.SafeString(accountsByType, typeVar, typeVar)
		var response interface{} = nil
		if IsTrue(hf) {
...
func (this *KucoinCore) FetchBorrowInterest(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes76158 := (<-this.LoadMarkets())
		PanicOnError(retRes76158)
		var marginMode interface{} = nil
...
func (this *KucoinCore) BorrowIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes79768 := (<-this.LoadMarkets())
		PanicOnError(retRes79768)
		var market interface{} = this.Market(symbol)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"currency":    GetValue(currency, "id"),
...
func (this *KucoinCore) RepayCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes80148 := (<-this.LoadMarkets())
		PanicOnError(retRes80148)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"currency": GetValue(currency, "id"),
			"size":     this.CurrencyToPrecision(code, amount),
...
func (this *KucoinCore) RepayIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes80498 := (<-this.LoadMarkets())
		PanicOnError(retRes80498)
		var market interface{} = this.Market(symbol)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"currency":   GetValue(currency, "id"),
	...
	go func() interface{} {
		...
		if IsTrue(IsTrue((!IsEqual(symbol, nil))) || IsTrue((IsTrue((!IsEqual(marketType, "spot"))) && IsTrue((!IsEqual(marketType, "margin")))))) {
			...
			if IsTrue(GetValue(market, "contract")) {
				...
				retRes818823 := (<-this.SetContractLeverage(leverage, symbol, params))
				PanicOnError(retRes818823)
				ch <- retRes818823
				return nil
			}
		}
		...
		retRes820515 := (<-this.PrivatePostPositionUpdateUserLeverage(this.Extend(request, params)))
		PanicOnError(retRes820515)
		ch <- retRes820515
		return nil
...
func (this *KucoinCore) SetContractLeverage(leverage interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		//    }
		//
		var leverageNum interface{} = this.SafeInteger(response, "leverage")
...
func (this *KucoinCore) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes825715 := (<-this.FetchFundingRate(symbol, this.Extend(params, map[string]interface{}{
			"uta": false,
		})))
		PanicOnError(retRes825715)
		ch <- retRes825715
		return nil
...
func (this *KucoinCore) FetchFundingRateHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		PanicOnError(retRes83948)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"symbol": GetValue(market, "id"),
		}
		var until interface{} = this.SafeInteger(params, "until")
		var uta interface{} = true // for backward compatibility, dafult endpoint is uta
...
func (this *KucoinCore) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes85638 := (<-this.LoadMarkets())
		PanicOnError(retRes85638)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"symbol": GetValue(market, "id"),
		}
...
func (this *KucoinCore) FetchMarketLeverageTiers(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes92618 := (<-this.LoadMarkets())
		PanicOnError(retRes92618)
		var market interface{} = this.Market(symbol)
		if !IsTrue(GetValue(market, "contract")) {
...
func (this *KucoinCore) FetchLeverageTiers(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes93578 := (<-this.LoadMarkets())
		PanicOnError(retRes93578)
		if IsTrue(IsEqual(symbols, nil)) {
		...
		for i := 0; IsLessThan(i, GetArrayLength(tiers)); i++ {
			...
			if IsTrue(!IsEqual(symbol, nil)) {
				...
				retRes941216 := GetValue(result, symbol)
				AppendToArray(&retRes941216, tier)
			}
		}
...
func (this *KucoinCore) FetchTransfers(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes954219 := (<-this.FetchPaginatedCallDynamic("fetchTransfers", code, since, limit, params))
			PanicOnError(retRes954219)
			ch <- retRes954219
			return nil
		}
		var request interface{} = map[string]interface{}{
