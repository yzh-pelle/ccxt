...
func  (this *GrvtCore) SignIn(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(this.UsesPrivateKey()) {
                ...
                retRes49312 := (<-this.SignInWithPrivateKey(params))
                PanicOnError(retRes49312)
        
                retRes49412 := (<-this.InitializeClient(params))
                PanicOnError(retRes49412)
            } else {
        
                retRes49612 := (<-this.SignInWithApiKey(params))
                PanicOnError(retRes49612)
            }
        
            retRes4988 := (<-this.LoadAccountInfos())
...
func  (this *GrvtCore) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsTrue(!IsEqual(this.PrivateKey, nil)) || IsTrue(!IsEqual(this.ApiKey, nil))) {
...
func  (this *GrvtCore) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes112819 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, maxLimit))
...
func  (this *GrvtCore) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes122019 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
...
func  (this *GrvtCore) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes12948 := (<-this.LoadMarketsAndSignIn())
...
func  (this *GrvtCore) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes13918 := (<-this.LoadMarketsAndSignIn())
...
func  (this *GrvtCore) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes14468 := (<-this.LoadMarketsAndSignIn())
...
func  (this *GrvtCore) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes16658 := (<-this.LoadMarketsAndSignIn())
            ...
            if IsTrue(paginate) {
                    ...
                    retRes167219 :=  (<-this.FetchPaginatedCallDynamic("fetchTransfers", nil, since, limit, params, maxLimit))
...
func  (this *GrvtCore) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes17498 := (<-this.LoadMarketsAndSignIn())
...
func  (this *GrvtCore) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes19198 := (<-this.LoadMarketsAndSignIn())
...
func  (this *GrvtCore) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes19698 := (<-this.LoadMarketsAndSignIn())
            ...
            var orderRequest interface{} = map[string]interface{} {
                ...
                "metadata": map[string]interface{} {
                    "client_order_id": Add(Add(ToString(this.Nonce()), "000"), ToString(this.RequestId())),
                },
...
func  (this *GrvtCore) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes22238 := (<-this.LoadMarketsAndSignIn())
            ...
            if IsTrue(paginate) {
                    ...
                    retRes222719 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes222719)
                    ch <- retRes222719
                    return nil
            }
            var request interface{} = map[string]interface{} {
            ...
            if IsTrue(!IsEqual(symbol, nil)) {
                ...
                retRes223612 := GetValue(request, "base")
                AppendToArray(&retRes223612, GetValue(market, "baseId"))
                AddElementToObject(request, "quote", []interface{}{})
                retRes223812 := GetValue(request, "quote")
                AppendToArray(&retRes223812, GetValue(market, "quoteId"))
            }
            if IsTrue(!IsEqual(limit, nil)) {
                AddElementToObject(request, "limit", mathMin(limit, 1000))
            }
...
func  (this *GrvtCore) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes22938 := (<-this.LoadMarketsAndSignIn())
            ...
            if IsTrue(!IsEqual(symbols, nil)) {
                ...
                for i := 0; IsLessThan(i, GetArrayLength(symbols)); i++ {
                    ...
                    retRes230716 := GetValue(request, "base")
                    AppendToArray(&retRes230716, GetValue(market, "baseId"))
                    retRes230816 := GetValue(request, "quote")
                    AppendToArray(&retRes230816, GetValue(market, "quoteId"))
                }
            }
...
func  (this *GrvtCore) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes24098 := (<-this.LoadMarketsAndSignIn())
...
func  (this *GrvtCore) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes24438 := (<-this.LoadMarketsAndSignIn())
...
func  (this *GrvtCore) FetchMarginModes(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes24998 := (<-this.LoadMarketsAndSignIn())
...
func  (this *GrvtCore) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes25538 := (<-this.LoadMarketsAndSignIn())
            ...
            if IsTrue(paginate) {
                    ...
                    retRes255719 :=  (<-this.FetchPaginatedCallDynamic("fetchFundingHistory", symbol, since, limit, params, 1000))
                    PanicOnError(retRes255719)
                    ch <- retRes255719
                    return nil
            }
            var request interface{} = map[string]interface{} {
            ...
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                AddElementToObject(request, "base", []interface{}{})
                retRes256612 := GetValue(request, "base")
                AppendToArray(&retRes256612, GetValue(market, "baseId"))
                AddElementToObject(request, "quote", []interface{}{})
                retRes256812 := GetValue(request, "quote")
                AppendToArray(&retRes256812, GetValue(market, "quoteId"))
            }
            if IsTrue(!IsEqual(limit, nil)) {
                AddElementToObject(request, "limit", mathMin(limit, 1000))
            }
...
func  (this *GrvtCore) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes26368 := (<-this.LoadMarketsAndSignIn())
            ...
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                AddElementToObject(request, "base", []interface{}{})
                retRes264412 := GetValue(request, "base")
                AppendToArray(&retRes264412, GetValue(market, "baseId"))
                AddElementToObject(request, "quote", []interface{}{})
                retRes264612 := GetValue(request, "quote")
                AppendToArray(&retRes264612, GetValue(market, "quoteId"))
            }
            if IsTrue(!IsEqual(limit, nil)) {
                AddElementToObject(request, "limit", mathMin(limit, 1000))
            }
...
func  (this *GrvtCore) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes27348 := (<-this.LoadMarketsAndSignIn())
...
func  (this *GrvtCore) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes28158 := (<-this.LoadMarketsAndSignIn())
...
func  (this *GrvtCore) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes30648 := (<-this.LoadMarketsAndSignIn())
            ...
            if IsTrue(!IsEqual(symbol, nil)) {
                var market interface{} = this.Market(symbol)
                AddElementToObject(request, "base", []interface{}{})
                retRes307112 := GetValue(request, "base")
                AppendToArray(&retRes307112, GetValue(market, "baseId"))
                AddElementToObject(request, "quote", []interface{}{})
                retRes307312 := GetValue(request, "quote")
                AppendToArray(&retRes307312, GetValue(market, "quoteId"))
            }
...
func  (this *GrvtCore) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes30998 := (<-this.LoadMarketsAndSignIn())
