...
func  (this *OkxCore) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes165612 := (<-this.LoadTimeDifference())
...
func  (this *OkxCore) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes246719 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
...
func  (this *OkxCore) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes258119 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 200))
...
func  (this *OkxCore) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes268919 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 100))
                    PanicOnError(retRes268919)
                    ch <- retRes268919
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *OkxCore) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var req interface{} = map[string]interface{} {
                ...
                retRes301515 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func  (this *OkxCore) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var req interface{} = map[string]interface{} {
                ...
                retRes303815 :=  (<-this.CreateOrder(symbol, "market", "sell", cost, nil, this.Extend(req, params)))
...
func  (this *OkxCore) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes437219 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
...
func  (this *OkxCore) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes472319 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes472319)
                    ch <- retRes472319
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *OkxCore) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes490219 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes490219)
                    ch <- retRes490219
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *OkxCore) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes497715 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func  (this *OkxCore) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes500119 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes500119)
                    ch <- retRes500119
                    return nil
            }
...
func  (this *OkxCore) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes544719 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes544719)
                    ch <- retRes544719
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *OkxCore) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes555519 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func  (this *OkxCore) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes58838 := (<-this.LoadMarkets())
            PanicOnError(retRes58838)
            var market interface{} = this.Market(symbol)
...
func  (this *OkxCore) FetchPositionsForSymbol(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes605215 :=  (<-this.FetchPositions([]interface{}{symbol}, params))
...
func  (this *OkxCore) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes661415 :=  (<-this.FetchFundingRate(symbol, params))
...
func  (this *OkxCore) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes70108 := (<-this.LoadMarkets())
            PanicOnError(retRes70108)
            var market interface{} = this.Market(symbol)
...
func  (this *OkxCore) FetchBorrowRateHistory(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes72158 := (<-this.LoadMarkets())
            PanicOnError(retRes72158)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "ccy": GetValue(currency, "id"),
            }
...
func  (this *OkxCore) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes736815 :=  (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
...
func  (this *OkxCore) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes738215 :=  (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func  (this *OkxCore) FetchOption(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes84528 := (<-this.LoadMarkets())
            PanicOnError(retRes84528)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *OkxCore) FetchConvertTrade(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes87008 := (<-this.LoadMarkets())
            PanicOnError(retRes87008)
            var request interface{} = map[string]interface{} {
                "clTReqId": id,
            }
...
func  (this *OkxCore) FetchMarginAdjustmentHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes89798 := (<-this.LoadMarkets())
            PanicOnError(retRes89798)
...
func  (this *OkxCore) FetchLongShortRatioHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes91628 := (<-this.LoadMarkets())
            PanicOnError(retRes91628)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
