...
func  (this *KrakenCore) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes117519 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 720))
                    PanicOnError(retRes117519)
                    ch <- retRes117519
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *KrakenCore) CreateMarketOrderWithCost(symbol interface{}, side interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var req interface{} = map[string]interface{} {
                ...
                retRes163415 :=  (<-this.CreateOrder(symbol, "market", side, cost, nil, this.Extend(req, params)))
...
func  (this *KrakenCore) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            PanicOnError(retRes16488)
                ...
                retRes164915 :=  (<-this.CreateMarketOrderWithCost(symbol, "buy", cost, params))
...
func  (this *KrakenCore) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                AddElementToObject(params, "cursor", true)
                    ...
                    retRes309219 :=  (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "next_cursor", "cursor"))
                    PanicOnError(retRes309219)
                    ch <- retRes309219
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *KrakenCore) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes318315 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
...
func  (this *KrakenCore) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes349015 :=  (<-this.Transfer(code, amount, "spot", "swap", params))
                PanicOnError(retRes349015)
                ch <- retRes349015
                return nil
