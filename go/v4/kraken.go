...
func  (this *KrakenCore) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes117719 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 720))
                    PanicOnError(retRes117719)
                    ch <- retRes117719
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *KrakenCore) CreateMarketOrderWithCost(symbol interface{}, side interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var req interface{} = map[string]interface{} {
                ...
                retRes163615 :=  (<-this.CreateOrder(symbol, "market", side, cost, nil, this.Extend(req, params)))
                PanicOnError(retRes163615)
                ch <- retRes163615
                return nil
...
func  (this *KrakenCore) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            PanicOnError(retRes16508)
                ...
                retRes165115 :=  (<-this.CreateMarketOrderWithCost(symbol, "buy", cost, params))
...
func  (this *KrakenCore) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                AddElementToObject(params, "cursor", true)
                    ...
                    retRes309419 :=  (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "next_cursor", "cursor"))
...
func  (this *KrakenCore) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes318515 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
...
func  (this *KrakenCore) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes349215 :=  (<-this.Transfer(code, amount, "spot", "swap", params))
                PanicOnError(retRes349215)
                ch <- retRes349215
                return nil
