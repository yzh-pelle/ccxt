...
* jsDelivr: https://cdn.jsdelivr.net/npm/ccxt@1.92.31/dist/ccxt.browser.js
* unpkg: https://unpkg.com/ccxt@1.92.31/dist/ccxt.browser.js
...
```HTML
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/ccxt@1.92.31/dist/ccxt.browser.js"></script>
```
